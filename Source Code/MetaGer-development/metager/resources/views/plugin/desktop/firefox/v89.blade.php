...
<div class="card">
	...
	<ol>
		<li>{!! trans('plugin-desktop/desktop-firefox.default-search-v89.1') !!}</li>
		<li>{!! trans('plugin-desktop/desktop-firefox.default-search-v89.2') !!}</li>
		<li>{!! trans('plugin-desktop/desktop-firefox.default-search-v89.3') !!}</li>
	</ol>
</div>
<div class="card">
